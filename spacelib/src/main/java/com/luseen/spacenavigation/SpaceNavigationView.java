...
public class SpaceNavigationView extends RelativeLayout {
    ...
    private final int centreContentBgWight = (int) getResources().getDimension(com.luseen.spacenavigation.R.dimen.centre_content_bg_width);
    ...
    private void initAndAddViewsToMainView() {
         ...
         */
        LayoutParams centreBackgroundViewParams = new LayoutParams(centreContentBgWight, mainContentHeight);
